...
import { Case__Inner__param } from './param_type';
import { DirtiestCardInner as resolver } from '../../../Case/DirtiestDodgerCard';
...
const readerAst: ReaderAst<Case__Inner__param> = [
  {
    kind: "Linked",
    fieldName: "suspects",
    alias: null,
